...
GRPC_TRACE=all GRPC_VERBOSITY=DEBUG ./rdma-server $ip >xserver_rdma_log.log 2>xserver-rdma.log
...
# GRPC_TRACE=all GRPC_VERBOSITY=DEBUG ./server $ip >xserver_tcp_log.log 2>xserver-tcp.log  